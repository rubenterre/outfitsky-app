...
<section class="weather-card__details">
  {#if dataWeather}
    <div class="weather-card__detail weather-card__detail--feels">
      <img
        src={pressure}
        alt="Icono de presión atmosférica"
        class="weather-card__detail-icon weather-card__detail-icon--feels"
        aria-hidden="true"
      />
      <div class="weather-card__detail-text">
        <span class="weather-card__detail-value"
          >{dataWeather.main.pressure}hPa</span
        >
    ...
    <div class="weather-card__detail weather-card__detail--humidity">
      <img
        src={visibility}
        alt="Icono de visibilidade"
        class="weather-card__detail-icon weather-card__detail-icon--humidity"
        aria-hidden="true"
      />
      <div class="weather-card__detail-text">
        <span class="weather-card__detail-value"
  ...
  {#if dataResultsUV}
    <div class="weather-card__detail weather-card__detail--wind">
      <img
        src={UV}
        alt="Icono de indice UV"
        class="weather-card__detail-icon weather-card__detail-icon--wind"
        aria-hidden="true"
      />
      <div class="weather-card__detail-text">
        <span class="weather-card__detail-value"
          >{Math.round(dataResultsUV.daily.uv_index_max[0])}/10</span
        >
...
<section class="weather-card__sun-position">
  <div class="weather-card__sun-details">
    <img
      src={sunrise}
      alt="Icono de amancer"
      class="weather-card__detail-icon weather-card__detail-icon--wind"
      aria-hidden="true"
    />
    <div class="weather-card__detail-text">
      <span class="weather-card__detail-value"
        >{new Date(dataWeather.sys.sunrise * 1000).toLocaleTimeString("es-ES", {
          hour: "2-digit",
          minute: "2-digit",
        })}h</span
      >
  ...
  <div class="weather-card__sun-details">
    ...
    <div class="weather-card__detail-text">
      <span class="weather-card__detail-value"
        >{new Date(dataWeather.sys.sunset * 1000).toLocaleTimeString("es-ES", {
          hour: "2-digit",
          minute: "2-digit",
        })}h</span
      >
