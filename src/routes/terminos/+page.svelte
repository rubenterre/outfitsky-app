...
<section class="terms">
  <div class="terms__container">
    ...
    <section class="terms__section">
      <h2 class="terms__section-title">2. Identidade do titular</h2>
      <p class="terms__text">
        De conformidade coa normativa vixente, indícase a información básica do titular da aplicación:
      </p>
      <p class="terms__text">
        <strong class="terms__text-strong">Titular:</strong> Rubén Terré<br />
        <strong class="terms__text-strong">NIF/CIF:</strong> [Número de identificación fiscal]<br />
        <strong class="terms__text-strong">Domicilio:</strong> [Enderezo postal completo / domicilio profesional]<br />
        <strong class="terms__text-strong">Correo electrónico de contacto:</strong> info@rubenterre.com<br />
        <strong class="terms__text-strong">Sitio web:</strong>
        <a class="terms__link" href="https://www.rubenterre.com">https://www.rubenterre.com</a>
      </p>
    </section>

    <section class="terms__section">
      <h2 class="terms__section-title">3. Acceso e dispoñibilidade da aplicación</h2>
      <p class="terms__text">
        O titular facilitará o acceso á aplicación a través das plataformas oficiais de distribución (por exemplo, Google Play Store), reservándose o dereito a modificar, actualizar ou retirar a app en calquera momento.
      </p>
      <p class="terms__text">
        A dispoñibilidade e correcto funcionamento da aplicación poden verse afectados por factores alleos ao control do titular (conexión a Internet, estado da rede, dispoñibilidade de servizos de terceiros, etc.), polo que non se garante a súa continuidade ininterrompida.
      </p>
    </section>
    ...
    <section class="terms__section">
      ...
      <ul class="terms__list">
        <li class="terms__list-item">
          Utilizar a aplicación con fins contrarios á lei, á moral, á orde pública ou aos presentes termos.
        </li>
        <li class="terms__list-item">
          Danar, inutilizar, sobrecargar ou deteriorar a aplicación, os sistemas ou redes asociados, ou impedir o seu normal funcionamento.
        </li>
        <li class="terms__list-item">
          Tentar acceder de forma non autorizada a contas, sistemas, datos ou áreas restrinxidas da aplicación ou de terceiros.
        </li>
        <li class="terms__list-item">
          Empregar a aplicación para distribuír contidos ilícitos, ofensivos, difamatorios, xenófobos, discriminatorios ou que vulneren dereitos de terceiros.
        </li>
      </ul>
    </section>
    ...
    <section class="terms__section">
      ...
      <p class="terms__text">
        Recoméndase revisar a política de privacidade para obter información detallada sobre os datos tratados, as finalidades, as bases legais, os destinatarios e os dereitos das persoas usuarias.
      </p>
    </section>

    <section class="terms__section">
      <h2 class="terms__section-title">10. Exclusión de garantías e responsabilidade</h2>
      <p class="terms__text">
    ...
    <section class="terms__section">
      <h2 class="terms__section-title">11. Modificación dos termos</h2>
      <p class="terms__text">
    ...
    <section class="terms__section terms__section--last">
      <h2 class="terms__section-title">12. Lei aplicable e xurisdición</h2>
      <p class="terms__text">
