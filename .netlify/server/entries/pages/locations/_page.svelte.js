...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      ...
      $$renderer2.push(`<button type="button" class="locations__button svelte-hgrkjr"><img class="locations__icon svelte-hgrkjr"${attr("src", c.icon)}${attr("alt", c.name)}/> <h4 class="locations__h4 svelte-hgrkjr">${escape_html(c.name)}</h4></button>`);
    }
